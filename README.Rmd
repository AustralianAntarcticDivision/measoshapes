...
Here we explore the names in more detail. The northern regions are assigned codes that include "T" for **tropical**, but they aren't supposed to be part of MEASO. They share a sector but have no assigned zone. From `colour_values` on zone they get black. 
